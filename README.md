...
A Unity 6000.5+ project hosting the **Gradient ABCW** package: a 32-key colour/alpha gradient
with evaluation-time modulation, a Burst-compiled evaluation core, and a pure UI Toolkit editor.
